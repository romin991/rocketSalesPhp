     ...
     <div class="panel-body">
      <div class="row mbot15">
        ...
        <div class="col-md-2 border-right">
          <?php $where['status'] = $status; ?>
          <h3 class="bold"><a href="<?php echo site_url('clients/projects/'.$status); ?>"><?php echo total_rows('tblprojects',$where); ?></a></h3>
          <span class="text-<?php echo project_status_color_class($status,true); ?> bold">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php } ?>
              <td>
               <?php echo '<span class="label label-'.project_status_color_class($project['status']).' inline-block">'.project_status_by_id($project['status']).'</span>';
               ?>
             </td>
           </tr>
           <?php } ?>

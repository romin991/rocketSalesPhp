                                ...
                                <div class="ticket-status-inline">
                                    ...
                                    <div class="ticket-status hide">
                                        <div class="input-group">
                                            <select id="ticket_status_single" class="form-control" name="ticket_status_single">
                ...
                <div class="panel_s single-ticket-reply-area" <?php if (form_error('message') == ''){ ?>style="display:none;" <?php } ?>>
                    ...
                    <div class="row">
                        <div class="col-md-12 mtop20 text-center">
                            <button class="btn btn-info" type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('ticket_single_add_reply'); ?></button>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>

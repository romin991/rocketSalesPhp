	...
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="article_group_wrapper">
				<h4 class="bold"><i class="fa fa-folder"></i> <a href="<?php echo site_url('knowledge-base'); ?>?groupid=<?php echo $group['groupid']; ?>"><?php echo $group['name']; ?></a>
		...
		<div class="col-md-12">
			<?php foreach($groups as $group){ ?>
			<h4 class="bold mbot30"><i class="fa fa-folder"></i> <?php echo $group['name']; ?></h4>

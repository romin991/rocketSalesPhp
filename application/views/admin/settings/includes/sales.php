			...
			<div class="col-md-5">
				<div class="mtop30 text-right">
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_desc_estimate" name="settings[defaut_estimates_pipeline_sort_type]" value="asc" <?php if(get_option('defaut_estimates_pipeline_sort_type') == 'asc'){echo 'checked';} ?>>
						<label for="k_desc_estimate"><?php echo _l('order_ascending'); ?></label>
					</div>
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_asc_estimate" name="settings[defaut_estimates_pipeline_sort_type]" value="desc" <?php if(get_option('defaut_estimates_pipeline_sort_type') == 'desc'){echo 'checked';} ?>>
	...
	<div role="tabpanel" class="tab-pane" id="set_proposals">
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div class="mtop30 text-right">
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_desc_proposal" name="settings[defaut_proposals_pipeline_sort_type]" value="asc" <?php if(get_option('defaut_proposals_pipeline_sort_type') == 'asc'){echo 'checked';} ?>>
						<label for="k_desc_proposal"><?php echo _l('order_ascending'); ?></label>
					</div>
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_asc_proposal" name="settings[defaut_proposals_pipeline_sort_type]" value="desc" <?php if(get_option('defaut_proposals_pipeline_sort_type') == 'desc'){echo 'checked';} ?>>

					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-8">
								...
								<?php } ?>
								<h3 id="ticket_subject">#<?php echo $ticket->ticketid; ?> - <?php echo $ticket->subject; ?>
							...
							<div>
								...
								<div class="panel_s ticket-reply-tools">
									<div class="panel-body">
										<div class="row">
											<div class="col-md-5">
												<?php echo render_select('status',$statuses,array('ticketstatusid','name'),'ticket_single_change_status',do_action('default_ticket_status_on_reply_staff',5),array(),array(),'','',false); ?>
